...
export default defineConfig(({ mode }) => ({
  ...
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        name: "AI-ESS EHR — Surveillance-First Health Records",
        short_name: "AI-ESS EHR",
        description: "Offline-capable electronic health records with AI-powered syndromic surveillance.",
        theme_color: "#00873E",
